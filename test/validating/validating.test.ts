...
import { createSpectraInServices } from "../../src/language/spectra-in-module.js";

let services: ReturnType<typeof createSpectraInServices>;
let parse: ReturnType<typeof parseHelper<Model>>;
let document: LangiumDocument<Model> | undefined;

beforeAll(async () => {
  services = createSpectraInServices(EmptyFileSystem);
  const doParse = parseHelper<Model>(services.SpectraIn);
